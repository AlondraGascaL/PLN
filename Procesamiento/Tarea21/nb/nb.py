...
X_train, X_test, y_train, y_test = train_test_split(all_features, y, test_size=0.2, random_state=10)
X_train.shape
X_test.shape
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB2.txt','w',encoding="utf8")
f3.write("Atributo -> waterprojectcostsharing\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB2.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB3.txt','w',encoding="utf8")
f3.write("Atributo -> adoptionofthebudgetresolution\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB3.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB4.txt','w',encoding="utf8")
f3.write("Atributo -> physicianfeefreeze\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB4.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB5.txt','w',encoding="utf8")
f3.write("Atributo -> elsalvadoraid\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB5.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB6.txt','w',encoding="utf8")
f3.write("Atributo -> religiousgroupsinschools\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB6.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB7.txt','w',encoding="utf8")
f3.write("Atributo -> antisatellitetestban\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB7.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB8.txt','w',encoding="utf8")
f3.write("Atributo -> aidtonicaraguancontras\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB8.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB9.txt','w',encoding="utf8")
f3.write("Atributo -> mxmissile\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB9.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB10.txt','w',encoding="utf8")
f3.write("Atributo -> immigration\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB10.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB11.txt','w',encoding="utf8")
f3.write("Atributo -> synfuelscorporationcutback\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB11.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB12.txt','w',encoding="utf8")
f3.write("Atributo -> educationspending\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB12.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB13.txt','w',encoding="utf8")
f3.write("Atributo -> superfundrighttosue\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB13.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB14.txt','w',encoding="utf8")
f3.write("Atributo -> crime\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB14.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB15.txt','w',encoding="utf8")
f3.write("Atributo -> dutyfreeexports\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB15.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
...
y_pred = classifier.predict(X_test)
f3 = open ('cassReportNB16.txt','w',encoding="utf8")
f3.write("Atributo -> exportadministrationactsouthafrica\n\n======================================\n"+"Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))
f3.close()
print("Porcentaje, {:.2f}".format(classifier.score(X_test, y_test)))

#Immprimir tabla en el txt
f3 = open ('cassReportNB16.txt','a',encoding="utf8")
f3.write("\n======================================\n"+"Classification Report\n\n" +str(classification_report(y_test,y_pred)))
f3.close()
